...
//    TODO: Refer question to user
    ...
    public Question(String description, List<QOption> options, Integer correctOption){
    ...
    public void addOptions(List<QOption> options){
        for (QOption o: options) { o.setQuestion(this);}
    }
